 ...
 * 
 * @author  Eric H, Tobias K, and other students from the University of Duisburg-Essen (Prof. Stefan Stieglitz)
 * @copyright University of Duisburg-Essen, Prof. Stefan Stieglitz
 * @license GPL 2.0
 * @version 1.0.0
 * 
 */
